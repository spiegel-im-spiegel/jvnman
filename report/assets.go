...
var _Assets6a710ffe05355fd8de925514584ec37062ef3c9c = "| ID  | タイトル | 想定される影響 | 深刻度 | 発見日 | 最終更新日 |\n| --- | -------- | -------------- | ------ | ------ | ---------- |\n{{ range . }}| [{{ .ID }}]({{ .URI }}) | {{ .Title }} | {{ .Impact }} | {{ .Severity }} | {{ .DatePublic }} | {{ .DateUpdate }} |\n{{ end }}\n"
